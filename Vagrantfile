...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "dockerbook" do |host|
      ...
      host.vm.provision "docker" do |d|
        ...
        #d.run "james_blog", image: "jekyll", args: "-v /vagrant/6/jekyll/james_blog:/data"
        ...
        #d.run "sample", image: "fetcher", restart: "no", cmd: "https://tomcat.apache.org/tomcat-8.0-doc/appdev/sample/sample.war"
        #d.build_image "/vagrant/6/tomcat/tomcat8", args: "-t tomcat8 --build-arg http_proxy=$http_proxy --build-arg https_proxy=$https_proxy"
        #d.run "sample_app", image: "tomcat8", args: "-P --volumes-from sample"
